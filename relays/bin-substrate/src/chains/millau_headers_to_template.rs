...
use relay_template_client::{Template, SigningParams as TemplateSigningParams};
...
impl SubstrateFinalitySyncPipeline for MillauFinalityToTemplate {
	...
	fn make_submit_finality_proof_transaction(
		...
		let call = template_runtime::BridgeCall::submit_finality_proof(header.into_inner(), proof).into();
