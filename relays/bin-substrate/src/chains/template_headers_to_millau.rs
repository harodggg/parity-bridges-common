...
//! Template-to-Millau headers sync entrypoint.
...
pub(crate) type TemplateFinalityToMillau = SubstrateFinalityToSubstrate<Template, Millau, MillauSigningParams>;

impl SubstrateFinalitySyncPipeline for TemplateFinalityToMillau {
	...
	fn make_submit_finality_proof_transaction(
		...
		header: TemplateSyncHeader,
		proof: GrandpaJustification<bp_template::Header>,
	) -> Bytes {
		let call = millau_runtime::BridgeGrandpaTemplateCall::<
			millau_runtime::Runtime,
			millau_runtime::TemplateGrandpaInstance,
